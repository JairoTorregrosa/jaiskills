...
- **Keep on-image text short.** GI2 garbles long sentences — use 5–8 word labels and numbers.
- For dense text (infographics, slides, multi-font layouts), use higher quality settings if exposed.
