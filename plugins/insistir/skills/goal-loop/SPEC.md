...
- P3.3 If a non-obvious problem was solved, `/insistir:compound` SHOULD be suggested.
...
Command: `/insistir:goal <objective> [--max-epochs N] [--patience N] [--judge codex|claude]`
